import { type ContractType, ContractTypes, getVerifiedContracts } from "@/data/walletTypes";
...
export class SmartWalletContractService {
   ...
   */
  async getSmartWalletExtensionContracts(walletAddress: string): Promise<ContractType[]> {
    try {
